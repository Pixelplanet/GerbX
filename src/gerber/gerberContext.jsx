...
export const GerberProvider = ({ children }) => {
    ...
    const defaultIsToggled = {
        toplayer: { trace: true, pads: true, silkscreen: true },
        bottomlayer: { trace: true, pads: true, silkscreen: true },
        commonlayer: { outline: true, drill: true, outlayer: true }
    };
    ...
    const [layers, setLayers] = useState([]); // Store raw/processed layer objects {filename, type, side, gerber, enabled}
